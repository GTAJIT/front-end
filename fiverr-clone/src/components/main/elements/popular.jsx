// const scrollContainer = document.getElementsByClassName("pop-section");
// const backBtn = document.getElementsByClassName("backward-btn");
// const nextBtn = document.getElementsByClassName("forward-btn");
  ...
  return (
    <div className="pop">
      ...
      <div className="pop-top">
        {/* <button className="backward-btn pop-btn-color">
          <svg
            className="arrows"
      ...
      {/* <button type="button" className="forward-btn pop-btn-color">
          <svg
            className="arrows"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 320 512"
